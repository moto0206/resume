...
-   チケット業務で、不具合の修正、QA 対応
-   新機能開発として、リソース重複を考慮した生産計画のスケジュール変更機能を開発
-   特定のお客様の技術拡張として、Salesforce から帳票出力ツールへの連携機能を開発

#### 2.販売管理システム開発

-   チケット業務で、不具合の修正、QA 対応
-   新機能開発として、「売上と請求を突き合わせる機能」の設計、開発を実施
-   新機能リリースあとに全社で、新機能概要の発表を実施

#### 3.企業間請求書支払システム

-   共同開発パートナー企業の要望を整理し、システム構成、ユーザーストーリー、設計書を作成
-   Salesforce プラットフォーム上で要望を実現するための技術選定、システム全体の開発方針を立案
-   外部決済処理への連携、Salesforce 組織間の請求書連携の設計開発を実施
-   社外に公開する API 仕様書を作成
-   外部決済処理（共同開発パートナー開発領域）との疎通確認を実施
-   コードレビューを担当し、システム全体の品質担保、品質向上を実施
-   プロジェクト途中から参加された技術パートナー企業へのコーディング方針の連携や、実装のフィードバックを実施
-   開発効率の向上のため、GitHub Copilot 活用、テスト駆動開発の推進を実施
