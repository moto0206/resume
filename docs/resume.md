...
| ---| ---| --- | ---|
<!-- 1行目 -->| 担当業務 | ・要件定義<br>・基本設計<br>・詳細設計<br>・実装<br>・テスト | 1 年<br>2 年<br>3 年<br>3 年<br>1 年 ||
<!-- 2行目 -->|OS・開発環境|・Windows|3年|通常使用に問題なし|
<!-- 3行目 -->|言語・フレームワーク|・Apex<br>・JavaScript<br>・HTML<br>・CSS|3 年<br>3 年<br>3 年<br>3 年|通常使用に問題なしで、指導も可能<br>通常使用に問題なしで、指導も可能<br>通常使用に問題なしで、指導も可能<br>通常使用に問題なしで、指導も可能|
<!-- 4行目 -->|その他ネットワーク、クラウド等|・Git<br>・Jenkins|3 年<br>3 年|通常使用に問題なしで、指導も可能<br>通常使用に問題なしで、指導も可能|
...
|期間|業務内容|環境|組織 / 役割|
|---|---|---|---|
<!--1行目 -->| 2022 年 4 月～現在   | 【プロジェクト内容】<br>　生産管理システム開発<br><br> 【担当業務】<br>・新規画面開発<br>・ビジネスロジック開発<br>・不具合修正<br>・QA調査<br><br>【成果・実績】<br>・チケット業務：不具合修正、QA 対応<br>・新機能開発：リソース重複を考慮した生産計画スケジュール変更機能の開発<br>・技術拡張：特定顧客向け Salesforce - 帳票出力ツール連携機能の開発| ・Apex<br>・JavaScript<br>・HTML<br>・CSS | 【組織】<br>チーム：5名<br>全体：15名<br><br>【役割】<br>メンバー |
<!--2行目 -->| 2023 年 4 月～現在   | 【プロジェクト内容】<br>　販売管理システム開発<br><br>【担当業務】<br>・新規画面開発<br>・ビジネスロジック開発<br>・不具合修正<br>・QA 調査<br><br>【成果・実績】<br>・チケット業務：不具合修正、QA 対応<br>・新機能開発：売上・請求突合機能の設計、開発<br>・新機能リリース後の全社向け概要発表実施| ・Apex<br>・JavaScript<br>・HTML<br>・CSS | 【組織】<br>チーム：5名<br>全体：15名<br><br>【役割】<br>メンバー
<!--3行目 -->|  2024 年 9 月～現在  | 【プロジェクト内容】<br>　企業間請求・支払 いシステムの新規 開発<br><br>【担当業務】<br>・ユーザーストーリー作成<br>・システム構成の設計<br>・API 連携開発<br>・パートナー企業とのやりとり<br>・コードレビュー<br><br>【成果・実績】<br>・共同開発パートナー企業の要望整理<br>・システム構成、ユーザーストーリー、設計書作成<br>・Salesforce プラットフォームでの要望実現に向けた技術選定<br>・外部決済処理連携、Salesforce 組織間請求書連携の設計開発<br>・社外公開用API 仕様書作成 <br>・外部決済処理（共同開発パートナー開発領域）との疎通確認<br>・コードレビュー担当、システム全体の品質担保、品質向上<br>・プロジェクト途中参画の技術パートナー企業へのコーディング方針連携、実装フィードバック<br>・開発効率向上のため、GitHub Copilot 活用、テスト駆動開発推進 | ・Apex<br>・JavaScript<br>・HTML<br>・CSS | 【組織】<br>チーム：5名<br>全体：15名<br><br>【役割】<br>メンバー<br>チームリーダー |
